<table class="table table-hover table-condensed table-striped">
    ...
    <g:each in="${products}" var="product">
        <tr>
            ...
            <td class='visible-md visible-lg visible-sm alignCenter borderLeft'><a href='#' alt='edit health product' data-toggle="modal" data-target="#editProductModal" onclick="setUpEditModal('${product.id}')"> Usage Ended </a> |
            <a href="#" data-href="${remoteFunction(controller: 'healthProduct',  action: 'delete', id: product.id, onSuccess:"updateProductTable()")}" data-toggle="modal" data-target="#confirm-delete">Delete</a></td>
        </tr>
    </g:each>
    </tbody>
</table>